...
const stores = [
    ...
    },
    {
        ...
        quote : "We had no idea how to get started, but bird showed us the way. And we were able to create something amazing",
        name: "John Prency",
    },
    {
        image : "/images/s-2.webp",
        quote : "The team at Bird is amazing. THey helped us create a stunning store that we are proud of.",
        name: "Miguel Martinez",
    }
]

const WordPressStores = () => {
    return ( 
        <section
      className=" mt-10 md:py-10 bg-[#bdb4ec] w-full
    rounded-3xl
...
export default WordPressStores;