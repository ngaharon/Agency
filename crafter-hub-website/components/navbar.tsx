...
const Navbar = () => {
    ...
    <div>
        <div className="p-6 md:p-10 flex items-center justify-between z-50">
            ...
            <div className="cursor-pointer hidden md:flex space-x-10 items-center text-slate-300 
            ...
            <div className="hidden md:flex">
                ...
                href="/contact"
                className="
                inline-flex h-12 animate-shimmer items-center justify-center rounded-md border 
